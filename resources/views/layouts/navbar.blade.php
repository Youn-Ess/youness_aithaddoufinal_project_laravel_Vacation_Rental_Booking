...
<nav class="relative px-4 py-3 flex justify-between items-center bg-gray-200">
    ...
    <ul
        ...
        <li><a class="text-sm text-gray-400 hover:text-gray-500 no-underline" href="{{ route('home.index') }}">Home</a>
        </li>
        ...
        <li><a class="text-sm text-gray-600 hover:text-gray-900 no-underline"
        ...
        <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('profile.index') }}">My profile</a></li>
        <li class="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li><a class="text-sm text-gray-400 hover:text-gray-500" href="{{ route('profile.edit') }}">Settings</a></li>
    </ul>
    ...
    <div class="hidden lg:inline-block ">
        <div class="flex items-center justify-center">
            <div class="bg-transparent text-center flex justify-center">
                <a href="{{ route('profile.index') }}" class="no-underline">
                    ...
                    {{-- <p class="text-gray-600 dark:text-gray-300">{{ Auth::user()->id }}</p> --}}
                </a>
                <div>
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
