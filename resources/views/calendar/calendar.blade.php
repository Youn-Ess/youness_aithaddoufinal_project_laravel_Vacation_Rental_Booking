<x-app-layout>
    ...
    <div class="bg-gray-100  h-[89vh] flex flex-col-reverse gap-y-9 items-center justify-center ">
        ...
        @include('calendar.components.updateModal')
    </div>
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            //     `   
                ...
                eventClick: (info) => {
                    ...
                    let user_role = info.event.extendedProps.role
                    if (auth_user_id != user_id && user_role != 'owner') {
                        return alert("this is not your reservation")
                    }
