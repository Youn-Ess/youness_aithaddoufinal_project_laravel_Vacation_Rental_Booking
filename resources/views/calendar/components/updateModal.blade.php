...
<button type="button" class="btn btn-primary d-none" id="updateModal" data-bs-toggle="modal" data-bs-target="#1updateModal">

</button>

<!-- Modal -->
<div class="modal fade" id="1updateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="1updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="1updateModalLabel">Modal title</h1>
